...
exp = Experiment('frierson_TracMIP_control_qflux', codebase=cb)

exp.inputfiles = ['./input/tracmip_qflux.nc']
...
exp.namelist = namelist = Namelist({
    ...
    'vert_coordinate_nml': {
        'bk': [0.000000, 0.0117665, 0.0196679, 0.0315244, 0.0485411, 0.0719344, 0.1027822, 0.1418581, 0.1894648, 0.2453219, 0.3085103, 0.3775033, 0.4502789, 0.5244989, 0.5977253, 0.6676441, 0.7322627, 0.7900587, 0.8400683, 0.8819111, 0.9157609, 0.9422770, 0.9625127, 0.9778177, 0.9897489, 1.0000000],
...
if __name__=="__main__":
    ...
    for i in range(2,181): #run 121 is 10 years. #241 is 20 years. run 181 is 12 years
